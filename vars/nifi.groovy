...
def createProcesGroupsAndDeployTemplate(URL, templateMap) {
    ...
    for (def key : templateMap.keySet()) {
        ...
        echo "I am here"
        GString deployTemplate = "'{\"templateId\":\"d29050f0-5627-42f8-b299-e5d8f6a692e7\",\"originX\":-0.0,\"originY\":-0.0}' http://192.168.56.105:8088/nifi-api/process-groups/${processGroupId}/template-instance"
        echo deployTemplate
