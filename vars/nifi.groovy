...
sh "curl -H \"Content-Type: application/json\" -X POST -d '{\"revision\":{\"version\":0},\"component\":{\"name\":\"test-to-delete\"}}' 192.168.56.105:8088/nifi-api/process-groups/e3f04b4f-015f-1000-b8f7-a1141fed5991/process-groups"
